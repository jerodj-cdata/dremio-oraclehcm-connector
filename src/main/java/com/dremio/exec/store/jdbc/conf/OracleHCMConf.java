...
@SourceType(value = "OracleHCMARP", label = "OracleHCM",uiConfig = "oraclehcm-layout.json")
public class OracleHCMConf extends AbstractArpConf<OracleHCMConf> {
  private static final String ARP_FILENAME = "arp/implementation/oraclehcm-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.oraclehcm.OracleHCMDriver";
